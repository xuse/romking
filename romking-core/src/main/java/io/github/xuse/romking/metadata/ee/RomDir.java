...
import io.github.xuse.romking.core.RomManager;
import io.github.xuse.simple.context.util.chinese.PinyinUtil;
...
public class RomDir {
	...
	public boolean parse() {
		...
		for(Element element:XMLUtils.childElements(doc.getDocumentElement(), "game")) {
			Game game= XMLUtils.loadBean(element, Game.class);
			games.add(game);
